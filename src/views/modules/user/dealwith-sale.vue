                    ...
                    >
                        <el-col :span="16">
                            <div style="display: flex;">
                                ...
                                ></upload-file>
                                <img-view
                                    v-if="tCustomerOrderRefund.refundFailPic && type"
                                    style="display: inline-block;"
      ...
      this.http(
        ...
        res => {
          if (res.data.code === 200) {
            ...
            this.adminAgree = this.tCustomerOrderRefund.adminIsAck
              ? this.tCustomerOrderRefund.adminIsAck + ""
              : "";
