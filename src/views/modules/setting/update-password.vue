<template>
    <div class="update-password-wrapper">
        ...
        <el-form ref="updatePasswordForm" :rules="rule" :model="updatePasswordForm" label-width="0px" style="margin-top: 20px; margin-left: 20px;">
            <el-form-item required>
                <el-input :disabled="true" v-model="updatePasswordForm.phone" placeholder="手机号" size="large" prefix-icon="iconfont iconshoujihao" style="width: 360px"></el-input>
            </el-form-item>
            <el-form-item prop="code" required>
                <el-input v-model="updatePasswordForm.code" placeholder="验证码" size="large" prefix-icon="iconfont iconyanzhengma" style="width: 244px"></el-input>
            ...
            <el-form-item prop="password" required>
                <el-input type="password" show-password v-model="updatePasswordForm.password" size="large" placeholder="新密码" prefix-icon="iconfont iconmima" style="width: 360px"></el-input>
            </el-form-item>
            <el-form-item prop="againPassword" required>
                <el-input type="password" show-password v-model="updatePasswordForm.againPassword" size="large" placeholder="确认密码" prefix-icon="iconfont iconmima" style="width: 360px"></el-input>
            </el-form-item>
            <el-form-item>
...
export default {
    ...
    mounted() {
        this.updatePasswordForm.phone = this.$cookie.get('phone')
    }
}
</script>
