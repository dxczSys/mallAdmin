<template>
    <div class="approval-detail-wrapper">
        ...
        >
            ...
            >
                <el-radio
                    :disabled="shopMess.shopApprovalStatus != '1'"
                    v-model="detailForm.approvalStutas"
                    label="2"
                >通过</el-radio>
                <el-radio
                    :disabled="shopMess.shopApprovalStatus != '1'"
            ...
            >
                <el-radio
                    :disabled="tAdvert.advertApprovalStatus != '1'"
                    v-model="detailForm.approvalStutas"
                    label="2"
                >通过</el-radio>
                <el-radio
            ...
            <el-form-item
                v-if="type == '1' && detailForm.approvalStutas == 3"
                label="拒绝原因:"
                prop="rejectReason"
                required
            >
                <el-input
                    ...
                    placeholder="拒绝原因：包含非法信息，最多100字"
                >
                </el-input>
            </el-form-item>
            <el-form-item
                v-if="type == '2' && detailForm.approvalStutas == 3"
                label="拒绝原因:"
                prop="rejectReason"
                required
            >
            ...
            <el-form-item>
                ...
                <el-button
                    v-if="shopMess.shopApprovalStatus == '1' || tAdvert.advertApprovalStatus == '1'"
                    @click="dealApproval"
                    type="primary"
                >批复</el-button>
            </el-form-item>
        ...
        res => {
          if (res.data.code == 200) {
            if (this.type == "1") {
              ...
              this.infoForm.bank_address_code = `${tShopVX.province_name}/${
                tShopVX.city_name
              }/${tShopVX.area_name}`;
              ...
              if (tShop.shopApprovalStatus != "1") {
                ...
                this.detailForm.rejectReason =
                  tShop.shopApprovalRefuseInfo + tShopVX.audit_detail;
              }
            } else {
            ...
            this.http(
              {
                ...
                data: {
                  ...
                  advertDurationDayNums: parseInt(
                    this.tAdvert.advertDurationDayNums
                  ),
