  ...
  methods: {
    ...
    initChart(start, end, topAd, proAd, topAdCopare, proAdCompare) {
      ...
      let option = {
        title: [
          {
            text: `${start.getFullYear()}年${start.getMonth() +
              1}月-${end.getFullYear()}年${end.getMonth() + 1}月广告收入`,
            left: 10,
            top: 10,
            textStyle: {
              color: "#fff"
    ...
    initSales(start, end, sales, users) {
      ...
      let option = {
        ...
        title: {
          text: `${start.getFullYear()}年${start.getMonth() +
            1}月-${end.getFullYear()}年${end.getMonth() + 1}月 交易额-用户量`,
          left: 10,
          top: 10,
          textStyle: {
            color: "#fff"
    ...
    initMechant(start, end, sales, orders) {
      ...
      this.mechantBar = echarts.init(
        document.getElementById("merchant-bar-line")
      );
