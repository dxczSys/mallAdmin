        ...
        <div class="order-table-box">
            <el-table :data="tableData" style="width: 100%;">
                ...
                <el-table-column header-align="center" align="center" width="100" label="操作">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.refundStatus == '3'" type="text" @click="dealWith(scope.row)">处理</el-button>
                        <el-button v-if="scope.row.refundStatus != '3'" type="text" @click="dealWith(scope.row, 1)">详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
