          ...
          <div class="color-picker-custom">
            ...
            >
              ...
              <el-button
                ...
                type="primary"
                :disabled="!item.nomalColor && !item.customColor"
                icon="el-icon-plus"
              ></el-button>
            </div>
          </div>
...
export default {
          ...
          if (!deepCompare(item, o[index])) {
            ...
            if (last) {
              for (let i = 0; i < o.length; i++) {
                if (
                  o[i].nomalColor == last ||
                  (o[i].nomalColor == "" && o[i].customColor == last)
                ) {
                  this.$nextTick((_) => {
  ...
  computed: {
    ...mapState('mall', ['mall', 'mall_id', 'shop_id', 'floor_id']),
    colorPickerTableCompute() {
  ...
  methods: {
    ...
    getKindsTree() {
      this.http(
        {
          url: `merchant/tGoodCategory/selectTGoodCategoryAsTree?shopMallId=${ this.mall.id }`,
          method: "get",
        },
        (res) => {
