  ...
  <div class="update-person-info-wrapper">
    ...
    <div class="avatar-box">
      ...
      <el-card class="deptment-right">
        ...
        <div style="padding-top: 30px">
          ...
          <span v-if="!nikeName && !isEdit" style="color: #999; font-size: 13px"
            >您尚未设置昵称</span
          >
          <el-input
            v-if="isEdit"
    ...
    <div class="base-mess-box">
      ...
      <div class="row-box">
        ...
        <div v-if="!chat && !isEditChat" style="color: #999; font-size: 13px">
          未绑定
        </div>
        ...
        <el-button
          v-if="!isEditChat"
          type="text"
          @click="isEditChat = !isEditChat"
          >修改绑定</el-button
        >
        <div style="color: #e6a23c; font-size: 12px; margin-left: 10px">
          提醒:请务必绑定微信号，而不是手机号，否则无法正常划账
        </div>
      </div>
      <div style="display: flex; align-items: center; margin-bottom: 20px">
        <div
      ...
      <div class="row-box">
        ...
        <span v-if="!isEditEmail && !email" style="color: #999; font-size: 13px"
          >您尚未设置邮箱</span
        >
        <el-input
          v-if="isEditEmail"
    ...
    >
      <div v-if="!nextStep">
        ...
        <div style="font-size: 13px">
          易码商城将给您{{ hiddenPhone }}的手机发送验证码，请您填写，5分钟内有效
        </div>
              ...
              if (this.checkEmail()) {
                this.http(
                  ...
                  (res) => {
                    if (res.data.code == 200) {
                      this.isEdit &&
                        (this.$cookie.set("userName", this.nikeName),
                        (this.isEdit = false));
                      this.isEditChat && (this.isEditChat = false);
                      this.isEditName &&
                        (this.$cookie.set("realUserName", this.realName),
