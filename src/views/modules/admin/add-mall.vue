        ...
        <div class="mall-mess">
            ...
            >
                ...
                >
                    <div
                        class="mall-adress"
                        :class="{ 'mall-adress-selected': mallForm.mallLng}"
                    >
                        <span>{{mallForm.mallAdress}}</span>
                        <span
                            style="padding-left: 10px;"
                            v-if="mallForm.mallLng"
                        >经度：{{mallForm.mallLng}}</span>
                        <span
                            style="padding-left: 5px;"
                            v-if="mallForm.mallLat"
                        >纬度：{{mallForm.mallLat}}</span>
                    </div>
                    <baidu-map
                        @getPoints="getPoints"
                ...
                <el-row :gutter="10">
                    ...
                    <el-col :span="12">
                        ...
                        >
                            <el-input
                                v-model="mallForm.phone"
                                placeholder="联系电话(固话(029)62******或手机)"
                                style="width: 360px;"
                            ></el-input>
                        </el-form-item>
                    </el-col>
                ...
                >
                    <el-tag
                        v-for="(item, index) in mallForm.floor"
                        :key="index"
                        :closable="!isUpdate"
                        @close="deleteFloor(index)"
                        style="margin-right: 10px; color: #409eff;"
                    >{{item}}楼</el-tag>
                    <span
                        v-if="!mallForm.floor.length"
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        mallAdress: [
          { required: true, message: "商城地址不能为空", trigger: "blur" }
        ],
        companyName: [
              ...
              this.http(
                {
                  ...
                  data: {
                    ...
                    shopLatitude: this.mallForm.mallLat,
                    shopIcon: res.data.data,
                    shopBusinessLicense: this.permitImg[0].url.split(
                      "filename="
                    )[1],
                    shopPropertyCompany: this.mallForm.companyName,
                    shopTel: this.mallForm.phone,
