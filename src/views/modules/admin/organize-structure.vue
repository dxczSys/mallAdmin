    ...
    <div class="organize-box">
      <div class="organize-left">
        ...
        <div class="organize-left-bottom">
          ...
          <el-dropdown
            v-if="role_id.includes('1')"
            class="organize-left-bottom-dropdown"
          >
      ...
      <div class="organize-right">
        <div style="display: flex; align-items: center">
          ...
          <div
            v-if="currentLevel == 1 || currentLevel == 2 || currentLevel == 4"
            style="font-weight: 600"
          >
            {{ currentLabel }}
          </div>
        ...
        <div
          class="floor-box"
          v-if="(currentLevel == 2 || currentLevel == 3) && !isAdmin"
        >
          <div
            class="floor-item"
          ...
          >
            ...
            <div
              ...
              style="text-align: center; padding: 20px 0; color: #999"
            >
              *当前楼层暂无商家入驻
            </div>
            <div
            ...
            <el-col :span="12">
              <div class="shop-mess-row">
                ...
                <img-view
                  ...
                  :images="[fileUrl + shopMessData.shopSign]"
                ></img-view>
              </div>
            </el-col>
            <el-col :span="12">
              <div class="shop-mess-row">
                ...
                <img-view
                  style="width: 100px; height: 120px"
                  :images="[fileUrl + shopMessData.shopBusinessLicense]"
                ></img-view>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row :gutter="10">
            <el-col :span="12">
              <div class="shop-mess-row">
                ...
                <img-view
                  style="width: 100px; height: 120px"
                  :images="[fileUrl + shopMessData.idCardPicPositive]"
                ></img-view>
              </div>
            </el-col>
            <el-col :span="12">
              <div class="shop-mess-row">
                ...
                <img-view
                  style="width: 100px; height: 120px"
                  :images="[fileUrl + shopMessData.idCardPicSide]"
                ></img-view>
              </div>
            </el-col>
          </el-row>
