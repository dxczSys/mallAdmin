  ...
  <div class="approval-manage-wrapper">
    ...
    <div class="count-wrapper">
      <el-row :gutter="0" justify="center">
        ...
        <el-col :span="8" v-if="!role_id.includes('2')">
          <el-card
            :body-style="{ padding: '15px' }"
            @click.native="index = 2"
            :class="{ currentBox: index == 2 }"
            class="card-item"
          >
            <div class="count-box">
              <div class="count-box-top">
  ...
  methods: {
    ...
    getTableData() {
      ...
      if (this.index != 3) {
        ...
        this.index == 0
          ? (obj.approvalType = undefined)
          : (obj.approvalType = this.index);
      }
      if (this.role_id.includes("1")) {
        this.http(
          {
