      ...
      <div class="filter-form">
        <div class="filter-form-row">
          <div class="filter-form-col">
            <label>商品编号</label>
            <el-input
              v-model="filterForm.goodsNumber"
              placeholder="商品编码"
            ></el-input>
          </div>
          <div class="filter-form-col">
        ...
        <div class="filter-form-row">
          <div class="filter-form-col">
            ...
            ></el-date-picker>
            <el-button @click="handleReset" style="margin-left: 36px"
              >重置</el-button
            >
            <el-button
              @click="getTableData"
      ...
      <el-table :data="orderTable" style="width: 100%" border>
        ...
        >
          <template slot-scope="scope">{{
            _dateFormat("YYYY-mm-dd HH:MM", scope.row.createTime)
          }}</template>
        </el-table-column>
        <el-table-column
          prop="goodTitle"
      ...
      this.http(
        {
          ...
          data: {
            ...
            t: {
              ...
              startDate: this.filterForm.dealTime
                ? this.filterForm.dealTime[0]
                : null,
              beginDate: this.filterForm.dealTime
                ? this.filterForm.dealTime[1]
                : null,
            },
          },
        },
