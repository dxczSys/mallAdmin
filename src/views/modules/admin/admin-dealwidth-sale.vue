  ...
  <div class="deal-with-sale-wrapper">
        ...
        >
          <el-col :span="20">
            ...
            <img-view
              ...
              :images="fileUrl + tCustomerOrderRefund.refundPic"
            ></img-view>
          </el-col>
        </el-row>
      </div>
    ...
    >
      ...
      <div class="logistics-info-box">
        ...
        <el-row
          v-if="tCustomerOrderDeliver.deliverPic"
          :gutter="20"
          style="margin-bottom: 20px;"
        >
          <el-col :span="20">
            ...
            <img-view
              style="display: inline-block;"
              :images="fileUrl + tCustomerOrderDeliver.deliverPic"
            ></img-view>
          </el-col>
        </el-row>
      </div>
          ...
          >
            <el-col :span="16">
              <div style="display: flex;">
                ...
                <img-view
                  v-if="tCustomerOrderRefund.refundFailPic"
                  style="display: inline-block;"
                  :images="fileUrl + tCustomerOrderRefund.refundFailPic"
                ></img-view>
              </div>
            </el-col>
          </el-row>
    ...
    <div
      v-if="tCustomerOrderRefund.refundStatus != '0' && tCustomerOrderRefund.refundStatus != '1' && tCustomerOrderRefund.refundStatus != '2'"
      class="deal-with-info"
    >
      <div style="display: flex;align-items: center;">
        <div style="width: 5px; height: 15px; background-color: #409eff;border-radius: 1px;margin-right: 3px;"></div>
          ...
          >
            <el-col :span="16">
              <div style="display: flex;">
                <label class="order-label">拒绝凭据</label>
                <upload-file
                  v-if="!type && tCustomerOrderRefund.refundStatus == '3'"
                  :filelist="rejectUrl"
                ></upload-file>
                <img-view
                  v-if="tCustomerOrderRefund.refundAdminFailPic && type"
                  style="display: inline-block;"
                  :images="fileUrl + tCustomerOrderRefund.refundAdminFailPic"
                ></img-view>
              </div>
            </el-col>
          </el-row>
