  ...
  data() {
    ...
    return {
      ...
      registerRules: {
        ...
        code: [
          { required: true, message: "请获取验证码并输入", trigger: "blur" }
        ],
        password: [
            ...
            this.http(
              ...
              res => {
                if (res.data.code == 200) {
                  ...
                  this.$cookie.set(
                    "roleId",
                    JSON.stringify([_data.roleLists[0].id])
                  );
                  this.$cookie.set("roleName", _data.roleLists[0].roleName);
                  this.$cookie.set(
                    "roleIdentify",
                    _data.roleLists[0].roleIdentify
                  );
